...
const PROVIDERS: Provider[] = [
  {
    ...
    tierDefaults: { opus: 'deepseek-reasoner', sonnet: 'deepseek-chat', haiku: 'deepseek-chat' },
  },
  {
    name: 'minimax',
    displayName: 'MiniMax',
  ...
  },
  {
    ...
    tierDefaults: { opus: 'moonshot-v1-128k', sonnet: 'moonshot-v1-32k', haiku: 'moonshot-v1-8k' },
  },
  {
    name: 'openrouter',
